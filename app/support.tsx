...
export default function SupportScreen() {
    ...
    const contactOptions = [
        { icon: 'chatbubble-ellipses-outline' as const, label: t('support', 'liveChat'), detail: t('support', 'liveChatDetail'), onPress: () => router.push('/inbox') },
        { icon: 'mail-outline' as const, label: t('support', 'emailUs'), detail: 'support@rentathing.com', onPress: () => Linking.openURL('mailto:support@rentathing.com') },
        { icon: 'call-outline' as const, label: t('support', 'callUs'), detail: t('support', 'callDetail'), onPress: () => Linking.openURL('tel:+1800000000') },
    ];
